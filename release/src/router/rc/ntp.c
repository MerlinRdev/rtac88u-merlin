...
#if defined(R8000P) || defined(R7900P) || defined(K3) || defined(SBRAC3200P) || defined(RTAC3100) || defined(RTAC3200) || defined(EA6700) || defined(RAX20) || defined(SBRAC1900P) || defined(XWR3100) || defined(RTAC88U)
		exec_uu_merlinr();
#else
		exec_uu();
#endif
